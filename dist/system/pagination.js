System.register(['aurelia-dependency-injection', 'aurelia-binding', 'aurelia-templating', 'spoonx/aurelia-orm'], function (_export) {
  'use strict';

  var inject, computedFrom, bindable, customElement, EntityManager, Pagination;
  ...
  return {
    ...
    }, function (_spoonxAureliaOrm) {
      EntityManager = _spoonxAureliaOrm.EntityManager;
    }],
    execute: function () {
      Pagination = (function () {
        ...
        Pagination = inject(EntityManager, Element)(Pagination) || Pagination;
        return Pagination;
      })();
